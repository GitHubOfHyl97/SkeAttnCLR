...
if __name__ == '__main__':
    ...
    processors = dict()
    processors['T_SNE_skeletonclr'] = import_class('processor.T_SNE_skeletonclr.FT_Processor')
    processors['T_SNE'] = import_class('processor.T_SNE.FT_Processor')
    processors['linear_evaluation_LWL'] = import_class('processor.linear_evaluation_LWL.LE_Processor')
    ...
    processors['pretrain_LWL'] = import_class('processor.pretrain_LWL.SkeletonCLR_Processor')
    processors['pretrain_SkeAttnLWL'] = import_class('processor.pretrain_SkeAttnLWL.SkeletonCLR_Processor')
