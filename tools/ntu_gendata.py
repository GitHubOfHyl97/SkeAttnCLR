...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/wwu25/wenhan/SkeAttnMask_test/data/NTU120/nturgb+d_skeletons')
    parser.add_argument(
        '--ignored_sample_path',
        default='/home/wwu25/wenhan/SkeAttnMask_test/data/NTU120/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='/home/wwu25/wenhan/SkeAttnMask_test/data/NTU120/NTU120_origin')
